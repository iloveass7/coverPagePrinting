    ...
    <div className="fixed inset-0 bg-transparent bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-2xl border-2 border-gray-300 p-8 max-w-2xl w-full mx-4">
        <div className="flex flex-col items-center">
          ...
          {/* Loading Message */}
          <h3 className="text-[1.5rem] font-semibold text-gray-800 mb-2">
            Processing...
          </h3>
          ...
          {token && (
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              ...
              <div className="bg-white border border-gray-300 rounded px-3 py-2">
                <code className="text-xl font-bold text-green-700 tracking-wider">
                  {token}
                </code>
              </div>
            </div>
...
const Form = () => {
  ...
  const validateForm = () => {
    ...
    const requiredFields = [
      ...
      {
        field: "assignmentNo",
        backendField: "assignmentNo",
        label: "Assignment No",
      },
      {
        field: "dateOfSubmission",
        backendField: "submissionDate",
        label: "Date of Submission",
      },
      {
        field: "submittedTo",
        backendField: "teacher",
        label: "Submitted To (Teacher Name)",
      },
    ];
    ...
    if (formData.studentId && !/^[a-zA-Z0-9-]+$/.test(formData.studentId)) {
      errors.push(
        "Student ID should contain only letters, numbers, and hyphens"
      );
    }
    ...
    if (formData.dateOfSubmission) {
      ...
      const isValidDateFormat =
        datePattern.test(formData.dateOfSubmission) ||
  ...
  const makeAPICall = async (endpoint, action) => {
    ...
    try {
      ...
      const { data } = await api.post(endpoint, backendData, {
        responseType:
          endpoint.includes("pdf") || endpoint.includes("docx")
            ? "blob"
            : "json",
      });
      ...
      <div className="bg-white rounded-lg shadow-lg border-2 border-gray-300 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 mb-3">
          ...
          <div className="bg-white text-gray-800 p-8 px-12 border-r border-gray-200">
            ...
            <div className="mb-6">
              <h2 className="text-[1.8rem] font-bold mb-2 text-gray-800">
                Student Information
              </h2>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-xl mb-8">
                Enter course and assignment details
              </p>
            ...
            <div>
              <h2 className="text-[2.2rem] font-bold mb-2 text-gray-800">
                Teacher Information
              </h2>
              <p className="text-gray-600 text-xl mb-6">
                Enter teacher and department details
              </p>
                ...
                <div>
                  <label className="block text-lg mb-2 text-gray-700">
                    ...
                    <span className="text-sm text-gray-500">
                      {" "}
                      (will be set to default Department if not filled)
                    </span>
                  </label>
                  <select
                    ...
                    className="w-full p-3 bg-white border border-gray-300 rounded text-gray-800 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
                  >
                    <option value="">Use Student's Department</option>
                    {DEPARTMENTS.map((dept) => (
                      <option key={dept} value={dept}>
                        {dept}
                      </option>
          ...
          <div className="bg-white p-8 px-10">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-xl mb-6">
                Review your assignment cover page before generating
              </p>
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="text-left space-y-4 mb-19">
                    <div className="flex leading-relaxed">
                      <span className="font-bold text-black w-38 text-lg">
                        Course No:
                      </span>
                      <span className="text-black text-lg">
                        {formData.courseNo || "Your course number"}
                      </span>
                    </div>
                    ...
                    <div className="flex leading-relaxed">
                      ...
                      <span className="text-black text-lg">
                        {formData.courseTitle || "Your course title"}
                      </span>
                    </div>
                    ...
                    <div className="flex leading-relaxed">
                      ...
                      <span className="text-black text-lg">
                        {formData.assignmentNo || "Your assignment number"}
                      </span>
                    </div>

                    {formData.assignmentName && (
                      <div className="flex leading-relaxed">
                        <span className="font-bold text-black w-46 text-lg">
                          Assignment Name:
                        </span>
                        <span className="text-black text-lg">
                          {formData.assignmentName}
                    ...
                    <div className="ml-6 space-y-2">
                      ...
                      <p className="text-black text-lg leading-relaxed">
                        {formData.teacherDepartment ||
                          formData.department ||
                          "Designated Teacher's Department"}
                      </p>
                    </div>
                  </div>
